...
export function analyseMatchings(options: number[][]): AnalysisResult {
...
/* ---------------------------------------------------------------------- */
/* Example invocation – remove/comment when importing as a module        */
/* ---------------------------------------------------------------------- */
...
const result = analyseMatchings(options);
console.log(JSON.stringify(result.neverUsed, null, 2))
console.log(JSON.stringify(result.alwaysUsed, null, 2))
console.log(JSON.stringify(result.removals, null, 2))