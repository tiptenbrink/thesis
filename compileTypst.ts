...
#canvas(length: 1cm, {
    ...
    // Draw mandatory parts (highlighted)
    for activity in activities {
      let y-offset = if activity.name == "a" { 0 } else if activity.name == "b" { 0 } else { 1 }
          let height = activity.usage
...
#canvas(length: 1cm, {
    ...
    let activities = (
      (name: "a", start: 0, duration: 1, color: red, usage: 1),
      (name: "b", start: 1, duration: 2, color: blue, usage: 1),  
      (name: "c", start: 1, duration: 2, color: green, usage: 2),
    )
...
#canvas(length: 1cm, {
    ...
    let activities = (
      (name: "a", start: 0, duration: 1, color: red, usage: 1),
      (name: "b", start: 1, duration: 2, color: blue, usage: 1),  
      (name: "c", start: 2, duration: 2, color: green, usage: 2),
    )
...
#canvas(length: 1cm, {
    ...
    let activities = (
      (name: "b", start: 0, duration: 2, color: blue, usage: 1),
      (name: "c", start: 0, duration: 2, color: green, usage: 2),  
    )
...
compileAll([
    ...
    [cumulFigureBad2, 'src/lib/assets/cumulFigureBad2.svg'],
    [cumulFigureBad3, 'src/lib/assets/cumulFigureBad3.svg'],
