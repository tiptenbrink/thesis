...
As the name suggests, in CP you describe problems using constraints. How does that look like? Well, consider we have, in some time window, 2 doctors available at a given moment and we need to perform 3 different operations. Operations a, b need 1 doctor. c needs 1 doctor. 
...
So what is now our main challenge?